...
# Script generated for node S3 Trusted Step Trainer
S3TrustedStepTrainer_node1690308773573 = glueContext.create_dynamic_frame.from_catalog(
    database="stedi",
    table_name="step_trainer_trusted",
    transformation_ctx="S3TrustedStepTrainer_node1690308773573",
)

# Script generated for node Join
Join_node1690309104474 = Join.apply(
    frame1=S3TrustedAccelerator_node1,
    frame2=S3TrustedStepTrainer_node1690308773573,
    keys1=["timestamp"],
...
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://stedi-lake-house-ng/step_trainer/machine_learning_curated/",
        "partitionKeys": [],
    },
